...
$\begin{aligned}
  \Lambda &= \begin{pmatrix}
   ...
   -\gamma \beta_1  & 1 + \tfrac{(\gamma-1)\,\beta_1^2}{\beta^2}  &
   1 + \tfrac{(\gamma-1)\,\beta_1\beta_2}{\beta^2} & 1 + \tfrac{(\gamma-1)\,\beta_1\beta_3}{\beta^2}\\
   -\gamma \beta_2  & 1 + \tfrac{(\gamma-1)\,\beta_2\beta_1}{\beta^2}  &
   1 + \tfrac{(\gamma-1)\,\beta_2^2}{\beta^2} & 1 + \tfrac{(\gamma-1)\,\beta_2\beta_3}{\beta^2}\\
   -\gamma \beta_3  & 1 + \tfrac{(\gamma-1)\,\beta_3\beta_1}{\beta^2}  &
