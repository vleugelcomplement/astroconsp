...
$\v H = \frac{Rc^2} \, \v d'' \times \v n, \; \v E = \frac{}{Rc^2} \, \v n \times (\v n \times \v d'')$

\begin{enumerate}
  \item $\v S = \frac{\v n}{4\pi c^3R^2}\,\Bigl\lvert\v d''\times\v n \Bigr\rvert^2 = 
    \mathcal W(\theta) \, \del \Omega$
...
\item $\del t = (1-\v n \v \beta) \, \del t_1$
\item $\mathcal W(\v n) = \frac{c}{4\pi} \, E^2 R^2 (1-\v n\v\cdot \beta)$
\item $\mathcal W(\v n) = \frac{e}{4\pi c^3} \cdot \frac{\Bigl(\v n \times \bigl((\v n - \v \beta) \times \v w\bigr)\Bigr)^2}{(1-\v n\v\cdot \beta)^5}$
\end{enumerate}
