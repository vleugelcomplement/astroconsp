...
\begin{defn}[Независимые случайные величины]\label{defn:stat::randvec::ind}
...
Здесь ещё была теорема почему они непараметрические, но я уже немного параметризован.
\end{document}
% vim:wrapmargin=3
